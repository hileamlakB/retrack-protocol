...
contract RetrackProtocol is ERC20 {
    ...
    event MoneyTransferred (address indexed from, address indexed to, uint256 amount);
    event MoneyRedeemed (address indexed from, address indexed redeemer, uint256 amount);
    event MoneyRetracked (address indexed from, address indexed by, uint256 amount);
    event RightTransferred (address indexed from, address indexed to, address indexed from_inital, uint256 ammount);
    ...
    function redeem (address from, uint256 redeem_amount) public {
        ...
        emit MoneyRedeemed(from, msg.sender, redeem_amount);
    ...
    function transferRight(address from, address to, uint256 amount, uint redeeming_period) public{
        ...
        emit RightTransferred(msg.sender, to, from, amount);
    ...
    function retrack (address from, uint256 amount) public{
        ...
        emit MoneyRetracked(from, msg.sender, amount);
